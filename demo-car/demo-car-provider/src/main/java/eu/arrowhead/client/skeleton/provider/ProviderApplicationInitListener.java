...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		//ServiceRegistryRequestDTO updateCarServiceRequest = createServiceRegistryRequest(CarProviderConstants.UPDATE_CAR_SERVICE_DEFINITION, CarProviderConstants.CAR_URI, HttpMethod.PUT);		
		//arrowheadService.forceRegisterServiceToServiceRegistry(updateCarServiceRequest);
	}
